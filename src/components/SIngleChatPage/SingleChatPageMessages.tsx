  ...
  messages && messages.map((msg) => {
    ...
    return (
      ...
      >
        ...
        <div className="w-full lg:w-[97%] mx-auto shadow-md lg:rounded-xl sticky bottom-[8.8%] md:bottom-18 lg:bottom-[2%] bg-white border-t-2 border-gray-300 lg:border-t-0  p-4 lg:p-[2%]">
